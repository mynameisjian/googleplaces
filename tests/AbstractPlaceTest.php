...
class AbstractPlaceTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @covers JianHan\GooglePlaces\AbstractPlace::__construct
     * @expectedException InvalidArgumentException
     */
    public function testConstruct_WithEmptyKey_ThrowException()
    {

    	$mockedAbstractPlace = $this->getMockBuilder($this->classNameToBeTested)
                                    ->setMethods(array('validateRequiredParameters'))
                                    ->setConstructorArgs([''])
                                    ->getMockForAbstractClass();	
    }
     ...
     * @covers JianHan\GooglePlaces\AbstractPlace::getRequestParameters
     */
    public function testSetRequestParameters_Successful()
    {

    	$validParameters = array('query' => 'test');

    	$this->mockedAbstractPlace->setRequestParameters($validParameters);

    	$this->assertEquals($this->mockedAbstractPlace->getRequestParameters(), $validParameters);
     ...
     */
    public function testGetInstance_WithEmptyImplementation_ThrowException()
    {

    	$serviceInstance = \JianHan\GooglePlaces\AbstractPlace::getInstance('UnknownService', 'validKey');
